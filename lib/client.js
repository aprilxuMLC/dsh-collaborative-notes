	...
	*/
	...
	function NotesController(React, clientCtx = {}) {
		...
		function NotesPanel({ sessionId, onClose, t: panelT = t }) {
			...
			const notesListEl = createElement("div", {
				style: {
					flex: "1",
					minHeight: "0",
					overflowY: "auto",
			...
			return createElement(
				...
				rawView ? rawEditorEl : searchOpen ? createElement("div", { style: {
					...
					display: "flex",
					flexDirection: "column"
				} }, editingIndex === null ? composerCardEl : null, notesListEl)) : createElement("div", { style: {
					flex: "1",
					minHeight: "0",
					display: "flex",
					flexDirection: "column",
					background: "#fff"
				} }, editingIndex === null ? composerCardEl : null, notesListEl),
				viewToggleRowEl,
				reentryStripEl,
